...
SECRET_KEY = 'django-insecure-xx-j%jn&62k5*yob$u#3u&@4zx4nbtc&0%1dyum@&=m5-hdl3n'
...
LOGGING = {
    ...
    "root": {
        ...
        'django': {
            'handlers': ['console'],
            'level': 'INFO',  # You can change this to DEBUG for more verbose output
            'propagate': True,
        },
        'student_feedback': { # Example for a custom logger in your app
            'handlers': ['console'],
            'level': 'DEBUG',
